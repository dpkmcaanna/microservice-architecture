...
class HotelControllerTest {
  ...
  @Test
  @DisplayName("When hotel by invalid id is requested then NOT_FOUND expected")
  void getHotelByIdRequested_Invalid() throws Exception {
    mockMvc
            .perform(get("/hotel/199"))
            .andExpect(status().is4xxClientError());
  }

  @Test
  @DisplayName("When hotel by invalid id is requested then hotel expected")
  void getHotelByIdRequested_Valid() throws Exception {
    mockMvc
            .perform(get("/hotel/1"))
            .andExpect(status().is2xxSuccessful());
  }
  ...
  @Test
  @DisplayName("When deleted hotel by id is requested then NOT_FOUND expected")
  void getHotelByIdRequested_Deted() throws Exception {
